...
(
  ...
  DEFAULT CHARSET=utf8  COMMENT '客户汽车信息 - 被推送';
...
(
  ...
  DEFAULT CHARSET=utf8  COMMENT '设备车位信息子表';
...
(
  ...
  DEFAULT CHARSET=utf8  COMMENT '本地同步日志表';
...
(
  ...
  DEFAULT CHARSET=utf8  COMMENT '存储FTP上面读取到的车牌信息，并且临时存储到本表';
...
(
  ...
  DEFAULT CHARSET=utf8  COMMENT '停车信息主 - 主动推送信 -&#&';
...
(
  ...
  DEFAULT CHARSET=utf8  COMMENT '停车信息日志表-当前表支持插入,不支持更新-每插入一条数据,需要更新';
DELIMITER ;
